...
// IMPORTANT: Thay thông tin này bằng credentials chính xác từ Mailtrap
define('MAIL_USERNAME', '3bd6db72da2cee'); // Copy từ Mailtrap
define('MAIL_PASSWORD', 'c491d43f2b962e'); // Copy từ Mailtrap
define('MAIL_PORT', 2525); // Mailtrap khuyên dùng port 2525
define('SENDER_MAIL', 'noreply@onlinenewssite.com');
define('SENDER_NAME', 'Online News Site');
