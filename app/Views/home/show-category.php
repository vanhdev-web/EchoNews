    ...
    <section class="py-5">
        <div class="container">
            ...
            <div class="posts-grid" id="postsGrid">
                ...
                <article class="post-card" data-date="<?= strtotime($post['created_at']) ?>" data-views="<?= $post['view'] ?>" data-comments="<?= $post['comments_count'] ?? 0 ?>">
                    <!-- Post Image -->
                        ...
                        <div class="post-meta">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <div class="post-stats">
                                    ...
                                    <i class="fas fa-comments ms-2 me-1"></i><?= $post['comments_count'] ?? 0 ?>
                                </div>
                            </div>
                        </div>
                    </div>
