...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <a role="button" href="<?= url('admin/posts/create') ?>" class="btn btn-primary" style="background-color: #0d6efd; border-color: #0d6efd; color: white;">
                ...
                <td class="border-0 text-center">
                    <div class="btn-group-vertical" role="group">
                        ...
                        <div class="btn-group" role="group">
                            <a href="<?= url('admin/posts/' . $post['id'] . '/edit') ?>" class="btn btn-outline-primary btn-sm" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="post" action="<?= url('admin/posts/' . $post['id'] . '/delete') ?>" style="display: inline;">
