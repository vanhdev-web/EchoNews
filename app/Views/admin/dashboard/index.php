                ...
                <div class="card-body p-4">
                    ...
                    <div class="mt-3 d-flex justify-content-between">
                        <small class="text-muted">
                            ...
                            Pending: <?= $commentStats['pending_count'] ?? 0; ?>
                        </small>
                        <small class="text-muted">
                            <i class="fas fa-check-circle me-1"></i>
                            Approved: <?= $commentStats['approved_count'] ?? 0; ?>
                        </small>
                    </div>
                </div>
            </div>
...
for($i = 6; $i >= 0; $i--) {
    ...
    $dayViews = 0;
    foreach(($viewData ?? []) as $dayData) {
        if(isset($dayData['date']) && $dayData['date'] == $date) {
            $dayViews = (int)($dayData['total_views'] ?? 0);
            break;
        }
    }
    $chartData[] = $dayViews;
